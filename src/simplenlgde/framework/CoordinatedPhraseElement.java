...
public class CoordinatedPhraseElement extends NLGElement {
    /** Coordinators which make the coordinate plural (eg, "und" but not "oder")*/
    private static final List<String> PLURAL_COORDINATORS = Arrays.asList("und", "sowie", "ebenso wie", "sowohl", "als auch", "wie auch");
    ...
    public CoordinatedPhraseElement() {
        super();
        this.setFeature(Feature.CONJUNCTION, "und"); //$NON-NLS-1$
    }
