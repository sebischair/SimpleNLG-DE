...
public enum Person {
     ...
     * person. First person narrative uses the personal pronouns of <em>ich</em>
     * and <em>wir</em>.
     */
    FIRST,
     ...
     * person. Second person narrative uses the personal pronoun of <em>du</em> and <em>ihr</em>.
     */
    SECOND,

    /**
     * The enumeration to show that the narration is written in the third
     * person. Third person narrative uses the personal pronouns of <em>er</em>,
     * <em>sie</em> and <em>es</em>.
     */
    THIRD;
}
