...
public abstract class InternalFeature {
    ...
    /**
     * <p>
     * This feature represents the list of modifier elements. Modifiers
     * are added to nouns in between the specifier and the noun.
     * </p>
     * <table border="1">
     * <tr>
     * <td><b>Feature name</b></td>
     ...
     * <tr>
     * <td><b>Created by</b></td>
     * <td>The user specifies the modifiers. Convenience methods are added.</td>
     * </tr>
     * <tr>
     * <td><b>Used by</b></td>
     * <td>The syntax processor correctly adds the modifiers into the
     * structure of the text.</td>
     * </tr>
     * <tr>
     * <td><b>Applies to</b></td>
    ...
    /**
     * For compound words, used by Morphology Processor to inflect nouns correctly,
     * e.g. "die Russische Föderation" -> "aus der RussischeN Föderation"
     */
    public static final String COMPOSITE = "composite";
    
    /**
     * For merged articles, e.g. zu + dem -> zum, used by Morphology Processor to inflect the article correctly
     */
    public static final String MERGED_ARTICLE = "merged_article";

    /**
     * Flag indicating if an NLGElement should be placed in between the parts of a separable verb
     */
    public static final String INBETWEEN_VERB = "inbetween_verb";
    
    /**
     * <p>
     * This feature contains the grammatical case of a component, which can be
     * <em>subject</em>, <em>genitive</em>, <em>indirect object</em> or <em>dative</em>.
     * </p>
     * <table border="1">
     * <tr>
     * <td><b>Feature name</b></td>
     ...
     * <tr>
     * <td><b>Created by</b></td>
     * <td>The grammatical case is set by the user.</td>
     * </tr>
     * <tr>
     * <td><b>Used by</b></td>
     * <td>The morphology processor uses the grammatical case to inflect words correctly.</td>
     * </tr>
     * <tr>
     * <td><b>Default</b></td>
     * <td><code>null</code></td>
    ...
    /**
     * <p>
     * This feature contains the grammatical case of a parent of a component, which can be
     * <em>subject</em>, <em>genitive</em>, <em>indirect object</em> or <em>dative</em>.
     * Sometimes, when the grammatical case is set to a phrase, it needs to be propagated
     * to its child elements.
     * When the child element does not possess an own grammatical case, that of the parent
     * is used. If the child possesses an own grammatical case, that of the parent is
     * ignored.
     * </p>
     * <table border="1">
     * <tr>
     ...
     * </table>
     */
    public static final String CASE_PARENT = "case_parent";
    
    /**
     * <p>
     * This feature contains the type of a modifier, which can be
     * <em>adjective</em>, <em>adverb</em> (which is not conjugated), or <em>other types of Strings</em>.
     * </p>
     * <table border="1">
     * <tr>
     * <td><b>Feature name</b></td>
     * <td><em>modifier_type</em></td>
     * </tr>
     * <tr>
     * <td><b>Expected type</b></td>
     * <td><code>NLGElement</code> or <code>String</code></td>
     ...
     * <tr>
     * <td><b>Created by</b></td>
     * <td>Can be set by user.</td>
     * </tr>
     * <tr>
     * <td><b>Used by</b></td>
     * <td>The morphology processor uses the modifier_type to inflect words correctly.</td>
     * </tr>
     * <tr>
     * <td><b>Default</b></td>
     * <td><code>null</code></td>
